...
Obtained data from Noise Pollution Clearinghouse (NPC) for noise statistics for 3 types of vehicles: Auto, Medium Truck, and Heavy Truck 

  - Provides dB (noise at 50 ft) for each vehicle type
 
  - Velocities 30-70 mph (~50-112)
